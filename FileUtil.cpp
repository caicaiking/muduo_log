...
FileUtil::AppendFile::AppendFile(string_arg filename)
...
FileUtil::ReadSmallFile::ReadSmallFile(string_arg filename)
...
template int FileUtil::readFile(string_arg filename, int maxSize,
